...
function addItem(e){
    ...
    if(newName.value===''||newDes.value===''||newPrice.value===''||newQuantity.value===''){
        ...
        axios.post("https://crudcrud.com/api/ff98600952e14304aa996ba7c2d55011/details",newUser)
            .then(response => {
...
window.addEventListener("DOMContentLoaded",() => {
    axios.get("https://crudcrud.com/api/ff98600952e14304aa996ba7c2d55011/details")
    .then(res=>{
        const data = res.data;
        data.forEach(item =>{
...
function buyCandy(itemId, quantityToBuy) {
    ...
    if (currentQuantity >= quantityToBuy) {
        ...
        axios.put(`https://crudcrud.com/api/ff98600952e14304aa996ba7c2d55011/details/${itemId}`,updatedCandy)
            .then(response => {
        ...
        if(newQuantity===0){
            axios.delete(`https://crudcrud.com/api/ff98600952e14304aa996ba7c2d55011/details/${itemId}`)
            .then(res =>{
                itemToUpdate.remove();
            })
            .catch(err=>{
